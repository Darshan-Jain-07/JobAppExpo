...
import ChatBotScreen from "./screens/chatbot/ChatScreen";
import CustomChatBotHeader from "./screens/chatbot/CustomChatBotHeader";
// import FAQ from "./screens/company/Help";
    ...
    <NavigationContainer>
      <Stack.Navigator>
        ...
        <Stack.Screen
          ...
          component={BottomNavigationApp}
        />
        <Stack.Screen
          options={{ headerShown: false }}
          name="Bottom Navigation Applicant"
          component={BottomNavigationJobSeeker}
        />
        <Stack.Screen
          options={{ headerShown: false }}
          name="Bottom Navigation Recruiter"
          component={BottomNavigationRecruiter}
        />
        <Stack.Screen
          options={{ headerShown: false }}
        ...
        <Stack.Screen
          options={{ headerShown: false }}
          name="View Recruiter Detail"
          component={ViewRecruiterDetail}
        />
        <Stack.Screen
          options={{
            headerShown: true,
        ...
        <Stack.Screen
          options={{
            headerShown: true,
            header: () => <CustomHeader title={"Resume Details Form"} />,
          }}
          name="Resume Form"
